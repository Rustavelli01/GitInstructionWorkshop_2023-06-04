...
Git - это система контроля версий. Хранилизе базы данных истории разработки проэкта, которая содержит все версии его файлов; как текущее, так и старые уже не актуальные версии
